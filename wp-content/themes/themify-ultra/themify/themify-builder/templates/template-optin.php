...
if ( 'on' === $fields_args['captcha']){
    $captcha_site_key = themify_builder_get( 'setting-recaptcha_site_key', 'builder_settings_recaptcha_site_key',true );
    $captcha_secret_key = themify_builder_get( 'setting-recaptcha_secret_key','builder_settings_recaptcha_secret_key',true );
}
?>
<!-- module optin -->
	...
	<?php if ($instance ):?>
	    ...
	    >
            ...
            <?php if (!empty($captcha_site_key) && !empty($captcha_secret_key) ) : ?>
                <?php
                $recaptcha_version=themify_builder_get( 'setting-recaptcha_version','builder_settings_recaptcha_version',true );
                $recaptcha_version='v3'===$recaptcha_version?'v3':'v2';
                ?>
